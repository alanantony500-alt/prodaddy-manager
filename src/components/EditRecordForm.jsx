...
export default function EditRecordForm({ initialData, onSuccess, isSeparateRoute }) {
  ...
  const [formData, setFormData] = useState({
    ...
    staff_commission: initialData.staff_commission || '',
    staff_id: initialData.staff_id || '',
    nationality: initialData.nationality || '',
    service_date: initialData.service_date || format(new Date(), 'yyyy-MM-dd'),
    service_time: initialData.service_time || format(new Date(), 'HH:mm'),
    room_number: initialData.room_number || '',
    service_timing: initialData.service_timing || '',
    body_size: initialData.body_size || '',
    behavior: initialData.behavior || '',
    repeat_customer: initialData.repeat_customer || false,
    mallu_customer: initialData.mallu_customer || false
  });
  ...
  const handleSubmit = async (e) => {
    ...
    delete submissionData.id; // remove id from update payload just in case

    const { error } = await supabase.from('records').update(submissionData).eq('id', formData.id);
